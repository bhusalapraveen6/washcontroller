# 1 "washing_machine_functions_def.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 285 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "washing_machine_functions_def.c" 2
...
# 16 "./main.h" 2
# 3 "washing_machine_functions_def.c" 2
extern unsigned char reset_flag ;
unsigned char operational_mode = 0x01;
unsigned char reset_flag = 0x11;
char *washing_program[]={"Daily", "Heavy" , "Dedicates", "Whites", "Stain wash" , "Ecocottons", "Woolens" , "Bed sheets", "Rinse+Dry" , "Dry only", "Wash only" , "Aqua store"};

double total_time , wash_time , rinse_time , spin_time , time ;
...
void power_on_screen(void)
{
    ...
    _delay((unsigned long)((100000)*(20000000/4000000.0)));
    }



    clcd_print("powering on",(0xC0 + 3));
    clcd_print("washing_machine",(0x90 + 1));
    ...
    _delay((unsigned long)((500000)*(20000000/4000000.0)));
...
void door_status_check(void)
{
    if(RB0 == 0)
    {
        ...
        clcd_print("Pls close door",(0xC0 + 0));
        while(RB0 == 0)
        {
            ;
        }
